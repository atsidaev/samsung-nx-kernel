...
static const char* g_pcnchBdVerPV3		= "PV3";
static const char* g_pcnchBdVerPV4		= "PV4";
static const char* g_pcnchBdVerPV5		= "PV5";
static const char* g_pcnchBdVerPR1		= "PR1";
static const char* g_pcnchBdVerPR1B	= "PR1B";
static const char* g_pcnchBdVerPR2		= "PR2";
static const char* g_pcnchBdVerPR3		= "PR3";
...
// -----------------------------------------	     eBdVer_PV1				eBdVer_PV2			eBdVer_PV3			eBdVer_PV4			eBdVer_PV5			eBdVer_PR1,				eBdVer_PR1B,				eBdVer_PR2,			eBdVer_PR3,			eBdVer_res	
const int gpio_SH_KEY2_MUIC[eBdVer_Max] = { DRIME4_GPIO9(0),		DRIME4_GPIO8(7),	DRIME4_GPIO8(7),	DRIME4_GPIO8(7),	DRIME4_GPIO8(7),	DRIME4_GPIO8(7),		DRIME4_GPIO8(7),		DRIME4_GPIO8(7),	DRIME4_GPIO8(7),	DRIME4_GPIO8(7),	};
...
void VersionInfo_Initialize(void)
{
	...
	*(volatile unsigned int *)(0xf804a400) &= 0xfffffff8;			// VA of 0x3006a400
	...
	{
		case 0:
			#ifdef CONFIG_NX300_PR3_BOARD
			g_eBoardVersion = eBdVer_PR3;
			#else
		...
		case 2:
			g_eBoardVersion = eBdVer_PV3;
			break;
			
		case 3:
			g_eBoardVersion = eBdVer_PV4;
			break;
			
		case 4:
			g_eBoardVersion = eBdVer_PV5;
			break;
		...
		case 6:
			g_eBoardVersion = eBdVer_PR1B;
			break;

		case 7:
			g_eBoardVersion = eBdVer_PR2;
			break;
...
const char* GetBoardVersionName(void) 
{
	...
	else if(g_eBoardVersion == eBdVer_PV3)
	{
		return g_pcnchBdVerPV3;
	}
	else if(g_eBoardVersion == eBdVer_PV4)
	{
		return g_pcnchBdVerPV4;
	}
	else if(g_eBoardVersion == eBdVer_PV5)
	{
		return g_pcnchBdVerPV5;
	}
	else if(g_eBoardVersion == eBdVer_PR1)
	{
		return g_pcnchBdVerPR1;
	}
	else if(g_eBoardVersion == eBdVer_PR1B)
	{
		return g_pcnchBdVerPR1B;
	}	
	else if(g_eBoardVersion == eBdVer_PR2)
	{
		return g_pcnchBdVerPR2;
	}
	else if(g_eBoardVersion == eBdVer_PR3)
	{
		return g_pcnchBdVerPR3;
	}
	else
	{

 ...
 * 
 */
#ifndef __GPIO_MAP_D4_NX300_H__
#define __GPIO_MAP_D4_NX300_H__
...
#define D4C_SPI_SCK				DRIME4_GPIO4(6)
#define D4C_SPI_DIN				DRIME4_GPIO4(7)


// GPIO Group 05 -------------------------------------------------------------------------------------------------------------------------
#define D4C_SPI_DOUT			DRIME4_GPIO5(0)
#define D4C_SPI_CS				DRIME4_GPIO5(1)
#define D4C_RESET				DRIME4_GPIO5(2)
...
#define D4C_AN_ON				DRIME4_GPIO8(3)	
#define GPIO_SH_MOT_IN1		DRIME4_GPIO8(4)
#define GPIO_SH_MOT_IN2		DRIME4_GPIO8(5)
#define D4C_CORE_ON			DRIME4_GPIO8(6)
#define LCD_BL_ON				DRIME4_GPIO8(7)


// GPIO Group 09 -------------------------------------------------------------------------------------------------------------------------
#define GPIO_SH_KEY2_MUIC		(gpio_SH_KEY2_MUIC[g_eBoardVersion])
#define WIFI_PWR_CNT			DRIME4_GPIO9(1)
#define D4C_IO_ON				DRIME4_GPIO9(2)
...
#define D4C_SPI_RST				DRIME4_GPIO11(2)
...
#define GPIO_G12_P03_NC		DRIME4_GPIO12(3)

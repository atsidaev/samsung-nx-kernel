/* linux/arch/arm/mach-drime4/board-d4jig2nd.c
 *
...
#include <mach/d4key_input.h>
#endif

#ifdef CONFIG_TSU6712
...
int drime_bat_init(void)
{}

void drime_bat_exit(void)
{}
...
static struct melfas_tsi_platform_data ts_config = {
	...
	.pin_num = DRIME4_GPIO12(2),
	.pwr_num = DRIME4_GPIO12(3),
...
static struct pinctrl_map drime4_padmux_map[] = {
	...
	PIN_MAP_MUX_GROUP_DEFAULT("dw_mmc.1", PINCTRL_DEV, NULL, "sd0"),
#else
	PIN_MAP_MUX_GROUP_DEFAULT("dw_mmc.0", PINCTRL_DEV, NULL, "sd0"),
#endif
...
#if defined(CONFIG_DRIME4_SDIO) || defined(CONFIG_DRIME4_EMMC)
	PIN_MAP_MUX_GROUP_DEFAULT("dw_mmc.0", PINCTRL_DEV, NULL, "sd1"),
#endif
...
static void __init drime4_init_d4es_i2c(void)
{
...
{
	pinctrl_register_mappings(drime4_padmux_map,
		ARRAY_SIZE(drime4_padmux_map));

	drime4_init_common_devices();
	drime4_init_d4es_i2c();
...
#endif
#ifdef CONFIG_MTD_NAND_DRIME4
	drime4_nand_set_platdata(&drime4_nand_info);
#endif
...
#endif
#ifdef CONFIG_UDD_PWM6
	platform_device_register(&pwmdev_device6);
#endif
#ifdef CONFIG_UDD_PWM7
...
#endif
#ifdef CONFIG_UDD_PWM9
	platform_device_register(&pwmdev_device9);
#endif
#ifdef CONFIG_UDD_PWM10
	platform_device_register(&pwmdev_device10);
#endif
#ifdef CONFIG_UDD_PWM11
	platform_device_register(&pwmdev_device11);
#endif
#ifdef CONFIG_UDD_PWM12
	platform_device_register(&pwmdev_device12);
#endif
#ifdef CONFIG_UDD_PWM13
	platform_device_register(&pwmdev_device13);
#endif
#ifdef CONFIG_UDD_PWM14
	platform_device_register(&pwmdev_device14);
#endif
#ifdef CONFIG_UDD_PWM15
	platform_device_register(&pwmdev_device15);
#endif
#ifdef CONFIG_UDD_PWM16
	platform_device_register(&pwmdev_device16);
#endif
#ifdef CONFIG_UDD_PWM17
	platform_device_register(&pwmdev_device17);
#endif
...
#endif
#ifdef CONFIG_UDD_SPI6
	platform_device_register(&spi_udd_device6);
#endif
#ifdef CONFIG_UDD_SPI7
...
#endif
	platform_add_devices(d4es_devices, ARRAY_SIZE(d4es_devices));
}

MACHINE_START(D4ES, "Samsung-DRIMeIV-ES")
/* Maintainer: */
	.atag_offset	= 0x100,

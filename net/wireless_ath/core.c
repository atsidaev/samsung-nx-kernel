...
#if 0 //donghyeon.kim (2013-02-26 09:37:52)
static bool cfg80211_disable_40mhz_24ghz;
#else
static bool cfg80211_disable_40mhz_24ghz = true;
#endif /* CONFIG_ARCH_S5C7380_BCM4325 */
...
#if 1 /* 20121126 Matt: initialize rfkill state */
	rfkill_init_sw_state(rdev->rfkill, 0);
#endif /* CONFIG_ARCH_S5C7380_BCM4325 */
...
#if 1 /* 20120906 Matt rfkill impelemtation */
#ifdef CONFIG_RFKILL
static int cfg80211_rfkill_set_block_2(void *data, bool blocked)
{
	struct cfg80211_registered_device *rdev = data;

	rdev->ops->rfkill_set_block(&rdev->wiphy);
	return 0;
}
#endif /* CONFIG_RFKILL */
#endif /* CONFIG_ARCH_S5C7380_BCM4325 */
...
#if 1 /* 20120906 Matt rfkill impelemtation */
#ifdef CONFIG_RFKILL
	rdev->rfkill_ops.set_block = cfg80211_rfkill_set_block_2;
#endif /* CONFIG_RFKILL */
#endif /* CONFIG_ARCH_S5C7380_BCM4325 */

...
enum elcd_out_type {
	LCD_OUT_DELTA_8BIT, LCD_OUT_STRIPE_24BIT, LCD_OUT_STRIPE_8BIT_MSB, /**< MSB 8 bit, 3Times Transmission */
	LCD_OUT_STRIPE_8BIT_LSB, /**< LSB 8 bit, 3Times Transmission */
	LCD_OUT_RGB_DUMMY, /**< 8bite ?????? 4?? ????( R G B Dummy ?????? ) */
	LCD_OUT_RGB656, /**< ???? 16bit ??? R:6 G:5 B:6 */
	LCD_OUT_YCBCR_8BIT_CBYCRY, /**< YCbCr 8 Bit ???? Cb Y Cr Y ??  */
	LCD_OUT_YCBCR_8BIT_CRYCBY, /**< YCbCr 8 Bit ???? Cr Y Cb Y ??  */
	LCD_OUT_YCBCR_8BIT_YCBYCR, /**< YCbCr 8 Bit ???? Y Cb Y Cr ??  */
	LCD_OUT_YCBCR_8BIT_YCRYCB, /**< YCbCr 8 Bit ???? Y Cr Y Cb ??  */
	LCD_OUT_YCBCR_16BIT_CBCR, /**< YCbCr 16 Bit ????{ Y Cb }, { Y Cr } */
	LCD_OUT_YCBCR_16BIT_CRCB, /**< YCbCr 16 Bit ????{ Y Cr }, { Y Cb } */
	LCD_OUT_CCIR656_CBCR, /**< CCIR 656 ????Cb Y Cr Y ??, 8bit ????*/
	LCD_OUT_CCIR656_CRCB
/**< CCIR 656 ????Cr Y Cb Y ??, 8bit ????*/
};
...
struct stfb_get_info {
	...
	struct stfb_lcd_pannel sub_pannel;
};

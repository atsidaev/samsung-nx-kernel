...
//#define _MFC_DEBUG_
//#define _MFC_DEBUG_SYNC_PRINT_
//#define _MFC_DEBUG_DIRECT_PRINT_
...
struct mfc_mem {
	...
	/* this value is caculated in mfc_init_buf() added 2012-04-27 */
	unsigned long	export_base; /* used for mmap */
	unsigned long	export_size; /* used for mmap */

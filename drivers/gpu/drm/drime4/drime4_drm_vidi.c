...
static struct drime4_drm_display_ops vidi_display_ops = {
	.type = DRIME4_DISPLAY_TYPE_VIDI,
...
static struct drime4_drm_manager_ops vidi_manager_ops = {
	.dpms = vidi_dpms,
	.apply = vidi_apply,
	.commit = vidi_commit,
...
static struct drime4_drm_overlay_ops vidi_overlay_ops = {
	.mode_set = vidi_win_mode_set,
	.commit = vidi_win_commit,
	.disable = vidi_win_disable,
};

static struct drime4_drm_manager vidi_manager = {
	.pipe		= -1,
				...
				struct drm_file *file_priv)
{
	...
	struct drm_drime4_vidi_connection *vidi = data;
	...
	list_for_each_entry(encoder, &drm_dev->mode_config.encoder_list,
								head) {
		manager = drime4_drm_get_manager(encoder);
		display_ops = manager->display_ops;

		if (display_ops->type == DRIME4_DISPLAY_TYPE_VIDI) {

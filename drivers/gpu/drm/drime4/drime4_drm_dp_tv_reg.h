/* drime4_drm_dp_tv_reg.h
 *
 * Copyright (C) 2011 Samsung Electronics Co.Ltd
 * Authors:
 *	Somabha B <b.somabha@samsung.com>
 *
 ...
 *
 */
#ifndef _DRIME4_DRM_DP_TV_REG_
#define _DRIME4_DRM_DP_TV_REG_
...
/*	TV Video Ch0 HPos	*/
#define	H_START(x)			(((x) & 0x7ff) << 0)
#define H_END(x)			(((x) & 0x7ff) << 16)

/*	TV Video Ch0 VPos	*/
#define V_START(x)			(((x) & 0x7ff) << 0)
#define V_END(x)			(((x) & 0x7ff) << 16)

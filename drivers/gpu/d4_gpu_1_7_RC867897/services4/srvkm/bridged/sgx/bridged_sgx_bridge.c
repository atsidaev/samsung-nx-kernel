...
#define ONLY_DRIME4_GPU_TEST
#ifdef ONLY_DRIME4_GPU_TEST
#include "mmap.h"
...
#ifdef ONLY_DRIME4_GPU_TEST
	PMUBase	= ioremap(0x30150000, 0x40);
	__raw_writel(readl(PMUBase+0x30)&(~0x1), PMUBase+0x30);
	msleep(1);
	__raw_writel(readl(PMUBase+0x34)&(~0x1), PMUBase+0x34);
	msleep(1);
	__raw_writel(readl(PMUBase+0x38)&(~0x1), PMUBase+0x38);
	msleep(1);
	__raw_writel(readl(PMUBase+0x3C)&(~0x1), PMUBase+0x3C);
	msleep(1);
#endif

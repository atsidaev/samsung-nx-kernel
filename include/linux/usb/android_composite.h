...
//#ifdef CONFIG_USB_ANDROID_SAMSUNG_COMPOSITE_ADVANCED
	int			(*bind_upper_config)(struct usb_composite_dev *cdev);
//#endif
};
...
#if 0
#define D4_NX300_UDC_MASS_PID		0x1397
#define D4_NX300_UDC_PICT_PID		0x1398

#define D4_NX2000_UDC_MASS_PID	0x1399
#define D4_NX2000_UDC_PICT_PID	0x139A
#else
	#if defined (CONFIG_MACH_D4_NX300)
		#define D4_UDC_MASS_PID	0x1397
		#define D4_UDC_PICT_PID	0x1398
	#elif defined (CONFIG_MACH_D4_NX2000)
		#define D4_UDC_MASS_PID	0x1399
		#define D4_UDC_PICT_PID	0x139A
	#else
		#define D4_UDC_MASS_PID	0x1397
		#define D4_UDC_PICT_PID	0x1398
	#endif	/* #if defined (CONFIG_MACH_D4_NX300) */
#endif	/* #if 0 */
